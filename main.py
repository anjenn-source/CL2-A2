...
#Functions
# Function for updating currency values in USD dictionary
def get_value_in_usd (required_currency):
    required_currency = str(required_currency).upper()
    return api_data["data"][required_currency]

# Function for getting currency symbol
def get_currency_symbol(required_currency):
    required_currency = str(required_currency).upper()
    return json_data['data'][f'{required_currency}']['symbol']


# Function for converting currency values
def convert():
